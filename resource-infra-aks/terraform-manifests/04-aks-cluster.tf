...
locals {
    ...
    log_workspace_name = "log-${project_name}-${environment}${location}${project_instance}"
    aks_cluster_name = "aks-${project_name}-${environment}${location}${project_instance}"
    node_resource_group = "nrg-${project_name}-${environment}${location}${project_instance}"
    nodepool_system_name = "npsystem-${project_name}-${environment}${location}${project_instance}"
